"""Training entrypoint for the steady Kovasznay PINN."""
...
def weighted_loss(model: PINN, mse_bnd: torch.Tensor, mse_phys: torch.Tensor) -> torch.Tensor:
    """Adaptive weighting between boundary and PDE residual terms."""
    return (
...
def main() -> None:
    wandb.init(project="pinn-kovasznay", name="Re20-LHS-Fourier", config=RUN_CONFIG)
