"""Residual-based adaptive refinement (RAR) for Kovasznay PINN."""
...
def main() -> None:
    ...
    for rar_idx in range(RAR_ITERS):
        ...
        tqdm.write(
            f"Max residual found: {max_res_value[0].item():.4e} | "
            f"Total Colloc Points: {x_colloc.shape[0]}"
        )
    ...
    def closure() -> torch.Tensor:
        nonlocal lbfgs_iter, global_step
